...
public class RegionFinderTest {
    private static final int maxColorDiff = 700;				// how similar a pixel color must be to the target color, to belong to a region
    ...
    public RegionFinderTest(BufferedImage image) {
        this.image = image;
    }
