...
public class RegionsTest extends DrawingGUI {
	...
	public RegionsTest(String name, RegionFinderV2 finder, Color targetColor) {
	...
	public static void main(String[] args) { 
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				new RegionsTest("baker", new RegionFinderV2(loadImage("/Users/danielcarstensen/IdeaProjects/PS1/baker.jpg")), new Color(130, 100, 100));
			}
		});
	}
}
